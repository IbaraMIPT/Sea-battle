...
/*
	...
	ОБЯЗАТЕЛЬНО заставить ботов сражаться друг с другом
	Сделать разные уровни сложности
	Разбить на файлы
	Будет проще ориентироваться и легче добалять ботов
	Покрасить корабли разных игроков в разные цвета для наглядности
	Допилить и сдать как второй проект
	Графон не обязательно: oldschool forever
*/
